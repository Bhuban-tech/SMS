...
export default function ContactsDocsPage() {
  return (
    <>
      <DocHeader
        title="Contacts"
        description="Manage individual contacts used for sending SMS messages in KritimSMS."
      />

     
      <DocSection title="Contacts Overview">
        <p>
          The Contacts module enables administrators to store, manage, and
          maintain individual contact information within the KritimSMS system.
          These contacts can later be used for individual messaging or grouped
