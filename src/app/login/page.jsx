            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 text-purple-600 hover:cursor-pointer"
                >
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-4 rounded-xl bg-teal-600 text-white font-semibold hover:bg-teal-700 transition duration-200 hover:cursor-pointer"
              >
