        ...
        <main className="flex-1 overflow-auto p-4 md:p-6 space-y-6">
          ...
          <div className="flex flex-col md:flex-row gap-4 items-stretch md:items-center">
            <input
              ...
              className="border bg-white px-4 py-2 rounded-xl shadow-sm outline-none w-full md:w-96 focus:ring-2 focus:ring-blue-500 transition-all"
            />
            ...
            <select
              ...
              className="border bg-white px-4 py-2 rounded-xl shadow-sm focus:ring-2 focus:ring-blue-500 transition-all"
            >
            ...
            <button
              ...
              className="flex items-center justify-center px-4 py-2 bg-teal-600 text-white rounded-xl shadow hover:bg-teal-700 disabled:opacity-70 transition-colors"
            >
                      ...
                      <td className="p-4">
                        <div className="flex justify-center">
                          <button
                            ...
                            className="bg-blue-500 hover:bg-blue-600 disabled:opacity-70 text-white p-2 rounded-full shadow transition-colors"
                          >
