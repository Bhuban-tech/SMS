          ...
          <table className="w-full">
            <thead className="bg-teal-700 border-b-2 border-teal-200">
              <tr>
                ...
                <th className="px-8 py-5 text-right text-xs font-bold text-white uppercase tracking-wider">
                  Amount
                </th>
                <th className="px-8 py-5 text-center text-xs font-bold text-white uppercase tracking-wider">
                  Status
                </th>
              </tr>
            </thead>
