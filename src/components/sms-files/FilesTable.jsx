          ...
          sortedFiles.map((row, index) => (
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-800">{row.author || "admin college"}</p>
              </div>

              <div>
                <p className="text-xs text-gray-500">File Name</p>
                <p className="text-gray-800">{row.originalFileName || "-"}</p>
              </div>

              <div>
                <p className="text-xs text-gray-500">Type</p>
                <p className="text-gray-800">{row.contentType || "-"}</p>
              </div>

              <div>
                <p className="text-xs text-gray-500">Size</p>
                <p className="text-gray-800">{row.fileSizeBytes || "-"}</p>
              </div>
